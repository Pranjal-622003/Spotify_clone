...
function playAll(songNumber){
    ...
    if(audioElement.getAttribute("src")==songFileName && !audioElement.paused){
        ...
        if (songNumber === 1) {
            banner.style.backgroundImage = "url(image2/b01.png)";
            bannerImage.setAttribute("src", "image2/image 1.png");
            bannerHeading.textContent = "Mike Posner - I took a pill in Ibiza (Cover)";
            bannerText.textContent = "By Ishaan Kaushik";
        } else if (songNumber === 2) {
            banner.style.backgroundImage = "url(image2/b02.png)";
            bannerImage.setAttribute("src", "image2/image 2.png");
            bannerHeading.textContent = "Ghar (Cover)";
            bannerText.textContent = "By Ishaan Kaushik";
        }
        else if (songNumber === 3) {
            banner.style.backgroundImage = "url(image2/b03.png)";
            bannerImage.setAttribute("src", "image2/image 3.png");
            bannerHeading.textContent = "Kahi to hogi woh (Cover)";
            bannerText.textContent = "By Ishaan Kaushik";
        }
        else if (songNumber === 4) {
            banner.style.backgroundImage = "url(image2/b04.png)";
            bannerImage.setAttribute("src", "image2/image 4.jpg");
            bannerHeading.textContent = "Kasoor (Cover)";
            bannerText.textContent = "By Ishaan Kaushik";
        }
        else if (songNumber === 5) {
            banner.style.backgroundImage = "url(image2/b05.png)";
            bannerImage.setAttribute("src", "image2/image 5.png");
            bannerHeading.textContent = "Tu Hai Kahan";
            bannerText.textContent = "By Ishaan Kaushik";
        }
        else if (songNumber === 6) {
            banner.style.backgroundImage = "url(image2/b06.png)";
            bannerImage.setAttribute("src", "image2/image 6.png");
            bannerHeading.textContent = "Baarishein - Anuv Jain (Cover)";
            bannerText.textContent = "By Ishaan Kaushik";
        }
        else if (songNumber === 7) {
            banner.style.backgroundImage = "url(image2/b07.png)";
            bannerImage.setAttribute("src", "image2/image 7.png");
            bannerHeading.textContent = "Waqt Ki Baatein (Cover)";
            bannerText.textContent = "By Ishaan Kaushik";
        }
        else if (songNumber === 8) {
            banner.style.backgroundImage = "url(image2/b08.png)";
            bannerImage.setAttribute("src", "image2/image 8.png");
            bannerHeading.textContent = "Lovely feat. Anika Vidyarthi (Cover)";
            bannerText.textContent = "By Ishaan Kaushik";
        }
        else if (songNumber === 9) {
            banner.style.backgroundImage = "url(image2/b09.png)";
            bannerImage.setAttribute("src", "image2/image 9.png");
            bannerHeading.textContent = "Let me down slowly - Alec Benjamin (Cover)";
            bannerText.textContent = "By Ishaan Kaushik";
        }
        else if (songNumber === 10) {
            banner.style.backgroundImage = "url(image2/b010.png)";
            bannerImage.setAttribute("src", "image2/image 10.png");
